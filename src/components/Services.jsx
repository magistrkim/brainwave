    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          <div
            className="relative flex z-1 items-center h-[39rem] 
                  mb-5 p-8 border border-n-1/10 rounded-3xl
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <div
              className="p-4 bg-n-7 lg:min-h-[46rem] rounded-3xl
                  overflow-hidden"
            >
              ...
              <div className="relative h-[20rem] md:h-[25rem] overflow-hidden rounded-xl bg-n-8">
                <img
                  src={service3}
                  alt="robot"
                  className="w-full h-full object-cover"
